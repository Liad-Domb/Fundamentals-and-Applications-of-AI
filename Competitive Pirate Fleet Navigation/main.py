...
import ex3_206444721_209149756
import sample_agent
...
class Game:
    ...
    def play_game(self):
        ...
        self.agents = [self.initiate_agent(ex3_206444721_209149756, 1),
        ...
        self.agents = [self.initiate_agent(sample_agent, 1),
                       self.initiate_agent(ex3_206444721_209149756, 2)]
...
def main():
    ...
    for i in range(10):
        ...
        print(f'Score for {ex3_206444721_209149756.IDS} is {results[0]}, score for {sample_agent.IDS} is {results[1]}')
