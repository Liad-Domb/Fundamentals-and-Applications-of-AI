import ex1_209149756_209249820
...
def check_problem(p, search_method, timeout):
    ...
    if isinstance(s, search_209149756_209249820.Node):
        solve = s
...
def solve_problems(problems):
    ...
    for problem in problems:
        try:
            p = ex1_209149756_209249820.create_onepiece_problem(problem)
        except Exception as e:
            print("Error creating problem: ", e)
            return None
        timeout = 60
        result = check_problem(
            p, (lambda p: search_209149756_209249820.astar_search(p, p.h)), timeout)
        print("A* ", result)
        if result[2] != None:
            if result[0] != -3:
                solved = solved + 1
...
def main():
    print(ex1_209149756_209249820.ids)
...
#------------------tests-----------
    ...
    # distances = ex1.bfs_consider_island(grid_map)
